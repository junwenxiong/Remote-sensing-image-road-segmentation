...
__all__ = [
    'PyConvHGResNet', 'pyconvhgresnet50', 'pyconvhgresnet101',
    'pyconvhgresnet152'
]
...
model_urls = {
    'pyconvhgresnet50':
    'https://drive.google.com/uc?export=download&id=14x0uss32ASXr4FJTE7pip004XZpwNrZe',
    'pyconvhgresnet101':
    'https://drive.google.com/uc?export=download&id=1Fm48GfOfn2Ivf5nBiR1SMhp66k67ePRh',
    'pyconvhgresnet152':
    'https://drive.google.com/uc?export=download&id=1LRmdQWTceDkepnIxZ2mWbpEE2lFxy0QO',
}
...
class PyConv2d(nn.Module):
    ...
    def __init__(self,
        ...
        for i in range(len(pyconv_kernels)):
            self.pyconv_levels[i] = nn.Conv2d(in_channels,
                                              out_channels[i],
...
class PyConvHGResNet(nn.Module):
    def __init__(self,
        ...
        if dropout_prob0 > 0.0:
            ...
            print("Using Dropout with the prob to set to 0 of: ",
                  dropout_prob0)
        else:
            self.dp = None
...
def pyconvhgresnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            torch.load(
                download_from_url(model_urls['pyconvhgresnet50'],
...
def pyconvhgresnet101(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            torch.load(
                download_from_url(model_urls['pyconvhgresnet101'],
                                  root=default_cache_path)))
    return model
